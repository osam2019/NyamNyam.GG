...
<div id="wrap">
  ...
  <el-menu-item index="5">Login</el-menu-item>
   ...
   <tr>
	   ...
	   <td>
	   <span id="FoodName">파스타</span>
	   <span id="rank" v-for="(item,index) in sortItems" v-if="item.name=='파스타'">({{index+1}}위)</span>
	   </td>
   </tr>
   </div>
   ...
   <div id="first-line">
   <span id="Image">
				<a href="#"><router-link to="/food"><img src="./img/pa2.jpg"></router-link></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/pa3.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/pa4.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/pa5.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/pa6.jpg"></a>
			</span>
   </div>
