...
<div id="wrap">
  ...
  <el-menu-item index="5"><router-link to="/">Log Out</router-link></el-menu-item>
   ...
   <tr>
       <td><img src="./img/kong.jpg"></td>
	   <td>
	   <span id="FoodName">콩국수</span>
	   <span id="rank" v-for="(item,index) in sortItems" v-if="item.name=='콩국수'">({{index+1}}위)</span>
	   </td>
   </tr>
   </div>
   ...
   <div id="first-line">
   <span id="Image">
				<a href="#"><router-link to="/food"><img src="./img/kong2.jpg"></router-link></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/kong3.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/kong4.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/kong5.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/kong6.jpg"></a>
			</span>
   </div>
