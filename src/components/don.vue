...
<div id="wrap">
  ...
  <el-menu-item index="5"><router-link to="/">Log Out</router-link></el-menu-item>
   ...
   <tr>
       <td><img src="./img/don.jpg"></td>
	   <td>
	   <span id="FoodName">돈까스</span>
	   <span id="rank" v-for="(item,index) in sortItems" v-if="item.name=='돈까스'">({{index+1}}위)</span>
	   </td>
   </tr>
   </div>
   ...
   <div id="first-line">
   <span id="Image">
				<a href="#"><router-link to="/food"><img src="./img/don2.jpg"></router-link></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/don3.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/don4.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/don5.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/don6.jpg"></a>
			</span>
   </div>
