...
<div id="wrap">
  ...
  <el-menu-item index="5"><router-link to="/">Log Out</router-link></el-menu-item>
   ...
   <tr>
       <td><img src="./img/Ka.jpg"></td>
	   <td>
	   <span id="FoodName">카레</span>
	   <span id="rank" v-for="(item,index) in sortItems" v-if="item.name=='카레'">({{index+1}}위)</span>
	   </td>
   </tr>
   </div>
   ...
   <div id="first-line">
   <span id="Image">
				<a href="#"><router-link to="/food"><img src="./img/Ka2.jpg"></router-link></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/Ka3.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/Ka4.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/Ka5.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/Ka6.jpg"></a>
			</span>
   </div>
