...
<div id="wrap">
  ...
  <el-menu-item index="5"><router-link to="/">Log Out</router-link></el-menu-item>
   ...
   <tr>
       <td><img src="./img/la.jpg"></td>
	   <td>
	   <span id="FoodName">라면</span>
	   <span id="rank" v-for="(item,index) in sortItems" v-if="item.name=='라면'">({{index+1}}위)</span>
	   </td>
   </tr>
   </div>
   ...
   <div id="first-line">
   <span id="Image">
				<a href="#"><router-link to="/food"><img src="./img/la2.jpg"></router-link></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/la3.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/la4.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/la5.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/la6.jpg"></a>
			</span>
   </div>
