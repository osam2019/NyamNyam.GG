...
<div id="wrap">
  ...
  <el-menu-item index="5"><router-link to="/">Log Out</router-link></el-menu-item>
   ...
   <tr>
       <td><img src="./img/zza.jpg"></td>
	   <td>
	   <span id="FoodName">자장면</span>
	   <span id="rank" v-for="(item,index) in sortItems" v-if="item.name=='자장면'">({{index+1}}위)</span>
	   </td>
   </tr>
   </div>
   ...
   <div id="first-line">
   <span id="Image">
				<a href="#"><router-link to="/food"><img src="./img/zza2.jpg"></router-link></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/zza3.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/zza4.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/zza5.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/zza6.jpg"></a>
			</span>
   </div>
