...
<div id="wrap">
 ...
 <el-menu-item index="5"><router-link to="/">Log Out</router-link></el-menu-item>
   ...
   <tr>
       <td><img src="./img/Seol.jpg"></td>
	   <td>
	   <span id="FoodName">설렁탕</span>
	   <span id="rank" v-for="(item,index) in sortItems" v-if="item.name=='설렁탕'">({{index+1}}위)</span>
	   </td>
   </tr>
   </div>
   ...
   <div id="first-line">
   <span id="Image">
				<a href="#"><router-link to="/food"><img src="./img/Seol2.jpg"></router-link></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/Seol3.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/Seol4.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/Seol5.jpg"></a>
			</span>
			<span id="Image">
				<a href="#"><img src="./img/Seol6.jpg"></a>
			</span>
   </div>
